...
import { Save, Download, Share2, Sparkles, Eye, FileText, ChevronDown, Users, History, Clock } from 'lucide-react'
import { scriptsApi } from '@services/apiServices'
import { SuccessModal, ErrorModal, PromptModal } from '@components/Modal'
  ...
  const fetchScriptData = async () => {
    ...
    try {
      ...
      if (versionsList.length > 0) {
        ...
        setScriptTitle(versionData.version_name || 'Untitled Script')
        ...
        <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {formatButtons.map((btn) => (
                <button
                  ...
                  className="px-3 py-1.5 text-sm rounded-lg bg-dark-100 hover:bg-primary-100 hover:text-primary-700 text-dark-700 transition-colors"
                  title={btn.hotkey}
                >
                  {btn.label}
                </button>
          ...
          <div className="card min-h-[600px]">
            <textarea
              ...
              className="w-full h-[550px] p-6 bg-white border border-dark-200 rounded-lg font-mono text-sm resize-none focus:outline-none focus:ring-2 focus:ring-primary-500"
        ...
        <div className="space-y-6">
          ...
          <div className="card">
            ...
            <div className="space-y-3">
              ...
              <div>
                <label className="block text-sm font-medium text-dark-700 mb-1">Genre</label>
                <select 
                  value={scriptGenre}
